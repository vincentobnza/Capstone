...
const Lesson5 = [
  ...
  {
    id: 11,
    question: "How can you retrieve a specific property value from an object?",
    options: {
  ...
  {
    id: 15,
    question: "How can you add a new property to an object using dot notation?",
    options: {
  ...
  {
    id: 20,
    question: "How can you reduce an array to a single value using a function?",
    options: {
