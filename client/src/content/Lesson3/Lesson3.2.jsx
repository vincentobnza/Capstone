...
export default function Lesson3_Topic2() {
  ...
  statements
        ...
        <Description>
          ...
          expression matches the value of any caseExpressionN, execution starts
          from the first statement after that case clause until either the end
          of the switch statement or the first encountered break.
        </Description>

        <Title>default Optional</Title>
        <Description>
          A default clause; if provided, this clause is executed if the value of
          expression doesn't match any of the case clauses. A switch statement
          can only have one default clause.
        </Description>
        ...
        <Description>
          ...
          the result of the input expression (using the{" "}
...
// only logs 1`}
        ...
        <Description>
          transfers control to that clause, executing statements following that
          clause. If no default clause is found, the program continu3:45 PMes
          execution at the statement following the end of switch. By convention,
          the default clause is the last clause, but it does not need to be so.
          A switch statement may only have one default clause; multiple default
