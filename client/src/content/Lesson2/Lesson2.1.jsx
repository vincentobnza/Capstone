  ...
  return (
    <div className="w-full max-w-screen-lg mx-auto bg-white dark:bg-zinc-900">
      <div className="flex flex-col gap-2">
        ...
        <Description>
          A variables is a container for a value, such a number we may use in a
          sum, or a string that we might use as a part of a phrase. So, in other
          words variables are used to store values.
        </Description>
        ...
        <Description>
          ...
          Variables can be declared in ways using the keyword “let”, “var”, and
          “const”.
        </Description>
        ...
        <Description>
          ...
          types are divided into primitive and non-primitive types. A primitive
          data type is either a data type that is build into a computer
          language, or one that may be classified as a basic foundation for
          developing more complicated data types, they can hold a single simple
          value ( String, Number, BigInt, Boolean, undefined, null, and Symbol).
          A non-primitive data type can hold multiple values (Objects) and are
          sometimes referred to as reference or derived data types.
        </Description>
        ...
        <ul className="mt-5 flex flex-col gap-4">
          <li className="list-decimal list-inside text-zinc-700 dark:text-zinc-400">
            <b className="text-zinc-800 dark:text-green-500">String</b> – It is
            a textual data surrounded by single or double quotes.
            <div className="p-4">
...
`}
              ...
              <Description>
                In this example, it checks if the variable isNicole is true. If
                it is, it prints “It’s a nice day” and if it’s not, it prints
                “It’s not a nice day!”
              </Description>
            </div>
          </li>
...
`}
              ...
              <Description>
                ...
                it has no value). If it is, it prints “x is empty”. If it has a
                value, it prints “x has a value”.
              </Description>
            </div>
          </li>
          <li className="list-decimal list-inside text-zinc-700 dark:text-zinc-400">
...
`}
          ...
          <li className="list-decimal list-inside text-zinc-700 dark:text-zinc-400">
            ...
            values. They are guaranteed to be unique, even if they have the same
            description.
          </li>
          <li className="list-decimal list-inside text-zinc-700 dark:text-zinc-400">
            <b className="text-zinc-800 dark:text-green-500">Object</b>– are
            collections of key-value pairs. Each key is a property name, and its
            corresponding value can be any data type, including other objects.
            Also, Objects is created using curly bracket {}.
            <div className="p-4">
              <Description>Example:</Description>
