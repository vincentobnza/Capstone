  ...
  return (
    <div className="w-full max-w-screen-lg mx-auto bg-white dark:bg-zinc-900">
      <div className="flex flex-col gap-2">
        ...
        <Description>
          In this language, the programs are referred to as scripts. They can be
          written directly in the HTML of a web page and launched instantly upon
          page load. Scripts are given as plain text and run in that format.
          They can operate without any additional setup or compilation.
          JavaScript and Java are two quite distinct languages in this regard.
        </Description>

        <Title>Why is it called JavaScript?</Title>
        <Description>
          JavaScript was first developed under the moniker "LiveScript."
          However, given the popularity of Java at the time, it was thought that
          marketing a new language as its "younger brother" would be beneficial.
        </Description>
        ...
        <Description>
          ...
          is JavaScript. Because of this, JavaScript is distinct. It is the most
          used tool for developing browser interfaces because of this.
          Nevertheless, JavaScript can be utilized to develop mobile apps,
          servers, and other software.
        </Description>
