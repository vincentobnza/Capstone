...
const Hero = () => {
  return (
    <div className="flex flex-col items-center justify-center w-full gap-4 p-6 text-center mx-lgauto max-w-screen- md:p-8 lg:p-8">
      ...
      <div className="mt-16 w-full h-[350px] md:h-[500px] flex flex-col items-center space-y-10 max-w-screen-md rounded-lg bg-white dark:bg-gradient-to-b dark:from-zinc-900 dark:to-zinc-950 border border-zinc-3 00 dark:border-zinc-800 relative">
        {/* BOOK  */}
