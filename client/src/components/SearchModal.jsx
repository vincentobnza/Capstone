      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-lg dark:bg-gradient-to-br dark:from-zinc-900 dark:to-zinc-800 border dark:border-zinc-700 bg-zinc-50 rounded-lg flex justify-center flex-col relative"
          >
