...
const DynamicSidebar = () => {
  ...
  return (
    <nav className="hidden md:flex bg-white dark:bg-zinc-900 p-4 w-64 h-screen overflow-y-auto fixed left-0 top-0 border-r border-zinc-2 dark:border-zinc-800">
